...
export default function HomeVariant4() {
  return (
    <div className="min-h-screen flex flex-col" style={{backgroundColor: '#F9FAFB'}}>
      ...
      <header className="sticky top-0 z-50 border-b" style={{backgroundColor: '#F97316'}}>
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <a href="/" className="flex items-center space-x-2">
              <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center shadow-lg">
                <span className="font-bold text-2xl" style={{color: '#F97316'}}>C</span>
              </div>
              <span className="text-2xl font-bold text-white">CoHire</span>
            </a>
            <div className="hidden md:flex items-center space-x-8">
              <a href="/" className="text-white hover:opacity-80 transition-colors font-medium">Home</a>
              <a href="/tools" className="text-white hover:opacity-80 transition-colors font-medium">Browse Tools</a>
              <a href="/rent" className="text-white hover:opacity-80 transition-colors font-medium">Rent Tools</a>
            </div>
            <div className="flex items-center space-x-4">
              <a href="/login" className="text-white hover:opacity-80 transition-colors hidden sm:block">Sign In</a>
              <a href="/signup" className="bg-white px-6 py-2.5 rounded-full hover:opacity-90 transition-all shadow-md hover:shadow-lg font-medium" style={{color: '#F97316'}}>Get Started</a>
            </div>
          </div>
        </nav>
      </header>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <div className="text-center mb-20">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight" style={{color: '#212121'}}>
              Rent Tools, Build
              <span style={{color: '#F97316'}}> Anything</span>
            </h1>
            ...
            <div className="flex justify-center space-x-4">
              <a href="/signup" className="text-white px-8 py-4 rounded-full hover:opacity-90 transition-all shadow-lg hover:shadow-xl font-semibold text-lg" style={{backgroundColor: '#F97316'}}>
                Find Tools
              </a>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-4" style={{backgroundColor: '#F97316', opacity: 0.1}}>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-4" style={{backgroundColor: '#FB923C', opacity: 0.1}}>
                <span className="text-2xl">💰</span>
              </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-4" style={{backgroundColor: '#EA580C', opacity: 0.1}}>
                <span className="text-2xl">✅</span>
              </div>
          ...
          {/* CTA Section */}
          <div className="rounded-3xl p-12 text-center text-white" style={{background: 'linear-gradient(135deg, #F97316 0%, #EA580C 100%)'}}>
            <h2 className="text-4xl font-bold mb-4">Ready to Start Your Project?</h2>
            <p className="text-xl mb-8 opacity-90">Join thousands of people renting tools in their neighborhood</p>
            <a href="/signup" className="bg-white px-8 py-4 rounded-full hover:bg-gray-100 transition-all shadow-lg font-bold text-lg inline-block" style={{color: '#F97316'}}>
              Get Started Today
            </a>
          </div>
        </div>
